...
public class Reservas{
  ...
  public static void main(String[] args) {
    ...
    Row row = null;
    Cell cell = null;
    int cantidadDatos = 100; // Cambia este valor según la cantidad de datos que desees generar
    ...
    for (int i = 0; i < cantidadDatos; i++) {
      ...
      try (FileOutputStream outputStream = new FileOutputStream("C:\\\\Users\\\\ltob9\\\\Desktop\\\\Reservas\\\\reservas.xlsx")) {
